	...
	<div class="wrapper">
        ...
        <li><a href="<?= base_url('Kalab/List_Teknisi') ?>"><i class="fas fa-clipboard-list mr-2"></i>List Teknisi</a></li>
		<li><a href="<?= base_url('Kalab/List_Laporan') ?>"><i class="fas fa-folder-open mr-2"></i>List Laporan</a></li>
		<li><a href="<?= base_url('Kalab/TTD_Laporan') ?>"><i class="fas fa-file-medical-alt mr-2"></i>Tanda Tangan Laporan</a></li>
