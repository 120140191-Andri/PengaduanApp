...
<body>
    ...
    <form action="<?= base_url('Teknisi/sys_ubah_laporan') ?>" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="nama_pelapor" placeholder="Nama Pelapor" value="<?= $laporan_n[0]->nama_pelapor ?>">
		
		<br>
		<br>
		<br>

        <input type="number" name="npm" placeholder="NPM" value="<?= $laporan_n[0]->npm ?>">
		
		<br>
		<br>
		<br>
		
		<textarea name="masalah" cols="30" rows="10" placeholder="Masalah" ><?= $laporan_n[0]->masalah ?></textarea>
	...
	<form action="<?= base_url('Teknisi/sys_selesaikan_laporan') ?>" method="post">
		<input type="hidden" name="id_prop" value="<?= $id_prop ?>">
		<input type="hidden" name="id_laporan" value="<?= $laporan_n[0]->id ?>">
		<input type="submit" value="Selesaikan Laporan">
	</form>
